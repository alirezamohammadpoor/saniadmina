...
(function() {
  "use strict";
  var _settings, _resizeObserver, _intersectionObserver, _onBlockSelect, _onBlockDeselect, _onInfoTriggerClick, _onFormSubmitBound, _abortController, _isLoading, _state, _muteUpdateSync;
  ...
  */
  ...
  const _VariantPickerOption = class _VariantPickerOption extends BaseComponent {
    constructor(el, options = {}) {
      ...
      const colorLabel = this.qs("[data-selected-color]");
      if (colorLabel) {
