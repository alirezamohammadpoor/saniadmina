...
(function() {
  ...
  */
  ...
  function init() {
    ...
    document.querySelectorAll(AnnouncementRotator.SELECTOR).forEach((el) => new AnnouncementRotator(el));
    document.querySelectorAll(CurrencySelector.SELECTOR).forEach((el) => new CurrencySelector(el));
    if (isThemeEditor()) {
